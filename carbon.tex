...
That seems wrong. We could have $H \notin F \land [\sum_{a \in H} c(a) ≤ M]$ (hence $\sum_{a \in H} p(a) > C$) though $\forall i \in \intvl{1, \card{H}}: \sum_{a \in H^m_{\intvl{1, i}}} p(a) ≤ C$.

But, that’s not the kind of tax that we want. Why? To be continued…

Consider $a_1$ and $a_2$ from different members, both $p(a) = C$.
