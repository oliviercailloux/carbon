...
\NewDocumentCommand{\OC}{m}{\textcolor{blue}{{\small$\big[$OC: #1$\big]$}}}
...
\NewDocumentCommand{\OCf}{m}{\textcolor{blue}{{\small\selectlanguage{french}$\big[$OC : #1$\big]$}}}
\NewDocumentCommand{\commentHG}{m}{\textcolor{red}{{\small$\big[$HG: #1$\big]$}}}
\NewDocumentCommand{\HG}{m}{\commentHG{#1}}
